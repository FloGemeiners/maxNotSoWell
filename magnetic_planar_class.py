...
Author:
    Florian Meiners - November 25, 2025; Last updated January 4, 2026
"""
...
class DirichletBCMagneticEdge:
    """
    Class to specify Dirichlet boundary condition for the H(curl) magnetic formulation with Nédélec edge elements.
    ...
    def values(self, nodes: np.ndarray, edges: np.ndarray) -> np.ndarray:
        ...
        edges : (n_edges, 2) array
            Global edge list (mesh.edges). Each row is (n0, n1) withm the chosen global orientation.
